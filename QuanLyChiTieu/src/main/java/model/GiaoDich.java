...
public class GiaoDich {
	private String id_GD, id_danhmuc, id_nguoidung, id_loai;
	...
	public GiaoDich(String id_danhmuc, String id_nguoidung, String id_loai, double so_tien, LocalDate ngay, int thang,
	...
	public String toString() {
		return "GiaoDich [id_GD=" + id_GD + ", id_danhmuc=" + id_danhmuc + ", id_nguoidung=" + id_nguoidung
				+ ", id_loai=" + id_loai + ", so_tien=" + so_tien + ", ngay=" + ngay + ", thang=" + thang + ", nam="
				+ nam + ", ghi_chu=" + ghi_chu + "]";
	}
